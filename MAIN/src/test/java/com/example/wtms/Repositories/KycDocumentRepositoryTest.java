...
class KycDocumentRepositoryTest {
    ...
    void createKycDocument_shouldSaveSuccessfully() {
        ...
        document.setDocumentNumber(documentNumber("PAN"));
    ...
    void fetchKycDocumentById_shouldReturnDocument() {
        ...
        document.setDocumentNumber(documentNumber("AADHAAR"));
    ...
    void findByUserId_shouldReturnAllKycDocumentsOfUser() {
        ...
        doc1.setDocumentNumber(documentNumber("PAN"));
        ...
        doc2.setDocumentNumber(documentNumber("AADHAAR"));
    ...
    private String documentNumber(String prefix) {
