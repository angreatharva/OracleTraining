...
/**
 * Validates the bearer token independently of the gateway.
 *
 * <p>This service listens on its own port, so it must not assume traffic arrived through the
 * gateway - anything on the local network can reach 8083 directly.</p>
 */
@Component
